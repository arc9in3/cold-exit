...
// Stock fallback icons by weapon name. Side-view PNG renders (via
// WEAPON_RENDER_BY_NAME in model_manifest.js) take precedence; this
// table is the secondary fallback for weapons that don't have a
// rendered PNG yet.
const WEAPON_ICON_BY_NAME = {
  'M1911':                  'ICON_SM_Wep_Pistol_01_Military_Underlay.png',
  'Glock 17':               'ICON_SM_Wep_Pistol_Small_01_Military_Underlay.png',
  'Makarov':                'ICON_SM_Wep_Pistol_01_Military_Underlay.png',
  'Colt Anaconda .44':      'ICON_SM_Wep_Revolver_Snub_01_BattleRoyale_Underlay.png',
  'Desert Eagle .50':       'ICON_SM_Wep_Pistol_Heavy_01_BattleRoyale_Underlay.png',
  'Colt Python':            'ICON_SM_Wep_Pistol_Revolver_01_BattleRoyale_Underlay.png',
  'Colt 357':               'ICON_SM_Wep_Pistol_Revolver_01_BattleRoyale_Underlay.png',
  '.38 Special':            'ICON_SM_Wep_Pistol_Revolver_01_BattleRoyale_Underlay.png',
  'Colt Six Shooter':       'ICON_SM_Wep_Pistol_Revolver_01_BattleRoyale_Underlay.png',
  'PDW':                    'ICON_SM_Wep_Preset_A_SMG_01_Military_Underlay.png',
  'P90':                    'ICON_SM_Wep_SubMGun_01_BattleRoyale_Underlay.png',
  'UMP45':                  'ICON_SM_Wep_Preset_B_SMG_01_Military_Underlay.png',
  'Spectre':                'ICON_SM_Wep_SubMGun_01_BattleRoyale_Underlay.png',
  'Spectre CQB':            'ICON_SM_Wep_SubMGun_Lite_01_BattleRoyale_Underlay.png',
  'SPC9':                   'ICON_SM_Wep_Preset_A_SMG_01_Military_Underlay.png',
  'AK47':                   'ICON_SM_Wep_Rifle_Assault_02_BattleRoyale_Underlay.png',
  'AKS-74':                 'ICON_SM_Wep_Rifle_Assault_02_BattleRoyale_Underlay.png',
  'AK104':                  'ICON_SM_Wep_Rifle_Assault_02_BattleRoyale_Underlay.png',
  ...
  'AUG A3-CQC':             'ICON_SM_Wep_Preset_B_Rifle_03_Military_Underlay.png',
  'CAR-15':                 'ICON_SM_Wep_Rifle_Assault_01_BattleRoyale_Underlay.png',
  'JARD J67':               'ICON_SM_Wep_Preset_A_Complex_01_Military_Underlay.png',
  'Type 80 LMG':            'ICON_SM_Wep_MachineGun_Bandit_01_Military_Underlay.png',
  'M249':                   'ICON_SM_Wep_MachineGun_USA_01_Military_Underlay.png',
  'Remington 700':          'ICON_SM_Wep_Rifle_01_Military_Underlay.png',
  'SVD Dragunov':           'ICON_SM_Wep_Preset_B_Sniper_01_Military_Underlay.png',
  'Cheytac Intervention':   'ICON_SM_Wep_Sniper_Heavy_01_BattleRoyale_Underlay.png',
  'AWP':                    'ICON_SM_Wep_Sniper_01_Military_Underlay.png',
  '.338 Lapua':             'ICON_SM_Wep_Sniper_Heavy_01_BattleRoyale_Underlay.png',
  'Hunting Rifle':          'ICON_SM_Wep_Rifle_01_Military_Underlay.png',
  'AA-12':                  'ICON_SM_Wep_Shotgun_01_BattleRoyale_Underlay.png',
  'Benelli M4':             'ICON_SM_Wep_Shotgun_01_Military_Underlay.png',
  'Mossberg 500':           'ICON_SM_Wep_Shotgun_01_Military_Underlay.png',
  'Remington 870':          'ICON_SM_Wep_Shotgun_01_Military_Underlay.png',
  'Sawed-Off Shotgun':      'ICON_SM_Wep_Shotgun_01_Military_Underlay.png',
  'KSG-12':                 'ICON_SM_Wep_Shotgun_01_BattleRoyale_Underlay.png',
  'Widowmaker Rocket Launcher': 'ICON_SM_Wep_Preset_B_Heavy_01_Military_Underlay.png',
  // Melee
  "Jessica's Rage":         'ICON_SM_Wep_Pistol_Heavy_01_BattleRoyale_Underlay.png',
  'Combat Knife':           'ICON_SM_Wep_Knife_01_Military_Underlay.png',
  'Hammer':                 'ICON_SM_Wep_Pan_01_BattleRoyale_Underlay.png',
  ...
  'Scimitar':               'ICON_SM_Wep_Sword_01_Military_Underlay.png',
};
...
export function iconForItem(item) {
  ...
  if (item.type === 'repairkit') {
    // No dedicated art yet — reuse the wrench / tool-shaped Items
    // category icon so the kit reads as utility rather than ammo.
...
// ---------------------------------------------------------------------
// Repair kits — a new item type. Drop a kit onto an armor / gear / weapon
// item (paperdoll slot OR grid cell) to restore a percentage of its
// max durability. Two flavors: armor kit covers all gear+armor slots,
// weapon kit covers ranged + melee weapons. Stack of 5; each kit has a
// rolled rarity that scales the per-use repair %.
//
//   repair % by rarity:
//     common 15%, uncommon 25%, rare 40%,
//     epic 55%, legendary 65%, mythic 75%
//
// Drop tables: ~7% chance to drop in regular body loot — see main.js
// buildBodyLoot. Only the def (id, name, type, target, stackMax) lives
// here; the rolled rarity + repairPct land on each spawned instance via
// `randomRepairKit`.
// ---------------------------------------------------------------------
...
// Rarity → repair percentage table. Index applied at spawn time so
// a single kit instance always heals the same fraction (no surprise
// re-rolls on use). Common is the floor; mythic kits don't normally
// drop in regular loot.
...
// Spawn a fresh repair-kit instance with a rolled rarity. `targetType`
// is 'armor' or 'weapon'. Distribution mirrors the level-light end of
// `rollWeaponRarity` — common is the floor (~50%), high-tier kits stay
// rare. Returns a stamped item ready to add() into the inventory.
export function randomRepairKit(targetType) {
  ...
  // Plain weighted roll — bias toward common but allow legendary on a
  // long-tail. Mirrors gear / weapon ramps without depending on
  // _lootLevel (kits drop equally well at any depth).
  const r = Math.random();
  let rarity = 'common';
  ...
  // count: 1 — repair kits stack via the standard CONSUMABLE/junk
  // path (we mirror via type+id match in Inventory.add).
  return stampItemDims({
    ...def,
    rarity,
    repairPct,
    count: 1,
...
// Roll a fresh kit of either flavor. Used by drop-table hooks that
// don't care which kind lands.
...
export class Inventory {
  ...
  // computes the repair %, bumps target.durability.current, decrements
  // the kit stack, and removes the kit when it hits zero. The
  // `potencyMult` is read from derivedStats.repairKitPotency (skill-tree
  // perks raise it); callers can pass an explicit override or rely on
  // the window.__derivedStats global.
  //
  // Returns true on a successful repair, false on validation fail (eg
  // kit type mismatch, target full HP, broken target ref).
  applyRepairKit(kit, target, potencyMult) {
    if (!kit || kit.type !== 'repairkit' || !target) return false;
    // armor kit covers both 'armor' and 'gear'; weapon kit covers
    // 'ranged' and 'melee'.
    ...
    if (cur >= max) return false;            // already full — no-op
    ...
    // Decrement stack; remove from grid if empty.
    ...
    if (count > 1) {
      ...
      if (g) g.remove(kit);
      // Clear any action-bar binding that pointed at this kit (defensive
      // — kits aren't quickslot-eligible, but the action-bar refresh
      // handles stale refs uniformly).
      for (let i = 0; i < this.actionBar.length; i++) {
    ...
    if (item.type === 'consumable'
      ...
      for (const g of this.allGridsIncludingPouch()) {
        for (const e of g.entries()) {
          ...
          // repairPct, so two stacks with different rarities can't
          // merge — otherwise a single stack would contain mixed
          // potency kits and the use-order would be ambiguous.
